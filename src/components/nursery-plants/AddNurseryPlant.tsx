  ...
  return (
    <div className="add-plant-stepper">
      <Steps current={currentStep} className="steps">
        <Steps.Step title="Plant Basic Details" onClick={() => handleStepClick(0)} />
      ...
      {currentStep === 0 && (
        <>
          ...
          {(selectedPlantTemplate || isAddPlantManually || createdPlantData) && (
            <CreatePlantForm
      ...
      {currentStep === 1 && (
        <div className="step-content" id='add-plant-step-2'>
          ...
          <ContainerDetails nurseryId={nurseryId} plantId={plantId} handleNext={handleNext} updateApi={nurseryPlantApi.updateNurseryPlant} />
        </div>
      )}
      {currentStep === 2 && (
        <div className="step-content" id='add-plant-step-2'>
