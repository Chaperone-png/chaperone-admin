...
export const dashboardCategories: Category[] = [
    {
      ...
      widgets: [
        { title: 'All Orders', firstCount: 5, secondCount: 10, secondCountPrefix: 'Rs.', secondCountSuffix: 'K', secondCountType: 'success', link: '/orders/all' },
        { title: 'Pending Orders', firstCount: 3, secondCount: 8, secondCountPrefix: 'Rs.', secondCountSuffix: 'K', secondCountType: 'success', link: `/orders/${orderStatusTypesData.Pending.value}` },
        { title: 'Completed Orders', firstCount: 5, secondCount: 10, secondCountPrefix: 'Rs.', secondCountSuffix: 'K', secondCountType: 'success', link: `/orders/${orderStatusTypesData.Delivered.value}` },
        { title: 'Cancelled Orders', firstCount: 3, secondCount: 8, secondCountPrefix: 'Rs.', secondCountSuffix: 'K', secondCountType: 'success', link: `/orders/${orderStatusTypesData.Cancelled.value}` },
    ...
    },
    {
      ...
      widgets: [
        { title: 'All orders', firstCount: 15, secondCount: 30, secondCountPrefix: 'Rs.', secondCountSuffix: 'K', secondCountType: 'success', link: ''  },
        { title: 'Cancelled orders', firstCount: 5, secondCount: 12, secondCountPrefix: 'Rs.', secondCountSuffix: 'K', secondCountType: 'danger', link: ''  },
    ...
    },
    {
      ...
      widgets: [
        { title: 'All orders', firstCount: 15, secondCount: 30, secondCountPrefix: 'Rs.', secondCountSuffix: 'K', secondCountType: 'success', link: ''  },
        { title: 'On-going orders', firstCount: 5, secondCount: 12, secondCountPrefix: 'Rs.', secondCountSuffix: 'K', secondCountType: 'danger', link: ''  },
        { title: 'Completed orders', firstCount: 5, secondCount: 12, secondCountPrefix: 'Rs.', secondCountSuffix: 'K', secondCountType: 'danger' , link: '' },
        { title: 'Cancelled orders', firstCount: 5, secondCount: 12, secondCountPrefix: 'Rs.', secondCountSuffix: 'K', secondCountType: 'danger', link: ''  },
